...
const projects = [
  ...
  {
    id: 2,
    title: 'ERP Software of Univeristies ✨',
    description: 'Build full fledged erp software for universities to manage students , staff , courses , exams and other activities .',
    image: img2,
    tags: ['Python', 'API Integration', 'Django','Azure', 'PostgreSQL'],
  ...
  { 
    id: 4,
    title: 'Hosted My ml project on azure',
    description: 'Deployed a machine learning model for heart disease detection on Microsoft Azure, enabling users to upload images and receive real-time analysis and recommendations.',
    image: img3,
    tags: ['Machine learning','Microsoft Azure','Jupyter Notebook','Python'],
    link: 'https://picaura.vercel.app/'
  },
  {
    id: 5,
    title: 'Product Recommendation System and sentiment Analysis',
    description: 'Upload your Excel file to instantly analyze customer reviews, generate sentiment scores, and view clean, structured insights for better product recommendations.',
    image: img1,
    tags: ['Streamlit', 'Deep learning', 'Machinelearning','Webscraping','HTML/CSS'],
